...
<Callout kind="info" collapsed="false">
  **In a Dual Review**, extraction works exactly as described on this page: Paperguide AI extracts and one assigned verifier checks. The one difference is timing. A paper becomes available for extraction as soon as its full text decision is final, so extraction can begin while screening is still finishing for other papers. See [Dual Review](/systematic-review/dual-review).
</Callout>
