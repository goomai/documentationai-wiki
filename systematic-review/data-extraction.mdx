...
- **What counts as missing**, so AI knows when to leave a field as not found.

If a field asks for a judgment, define what counts as evidence. If it asks for a value, specify the format you want returned.
