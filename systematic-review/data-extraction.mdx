...
---
<Video uid="35037ed2-ee76-4dab-84df-b0f96e44dfdd" src="https://www.youtube.com/embed/6bJ-Gs6WSm0" render-type="iframe" width="560" height="315" controls="true" allow-full-screen="true" />
...
<Callout kind="info" collapsed="false">
  **Before you start:** Your extraction fields must be defined in the [Protocol](/systematic-review/protocol), and full text screening must be confirmed ([AI Review](/systematic-review/ai-review/full-text-screening)) or the papers' full text decisions must be final ([Dual Review](/systematic-review/dual-review/full-text-screening)). Assign your verifier before starting, not after.
</Callout>
...
<Callout kind="info" collapsed="false">
  **In a Dual Review**, extraction works exactly as described on this page: Paperguide AI extracts and one assigned verifier checks. Extraction opens once full text screening is complete, meaning every paper with a PDF has both reviewers' decisions and every conflict is resolved. There is no confirm step for the screening stage itself. See [How Dual Review works](/systematic-review/dual-review/how-it-works#how-papers-move-between-stages).
</Callout>
...
[Building better extraction fields](/systematic-review/protocol#building-better-extraction-fields)
...
Paperguide sends an email when the run completes: to the assigned verifier, or, if the stage is unassigned, to every Full Access and Review member in a personal workspace and to the review creator only in an organization's team workspace.
