...
The AI recommendation is not the same as a verified final decision. You review the paper, inspect the criterion verdicts and evidence, then either confirm the result or change it.
