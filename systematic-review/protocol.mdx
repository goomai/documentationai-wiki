...
In a [Dual Review](/systematic-review/dual-review), the reviewer chooses the exclusion reason. When they exclude a paper, they pick the one criterion that best explains it, and that criterion is what the review reports.
...
Reset papers return to both reviewers' queues. Anything that followed from a reset decision, a conflict resolution, later-stage work on that paper, or a generated report, is cleared with it. [Dual Review](/systematic-review/dual-review#editing-the-protocol-during-screening) has the full table.
