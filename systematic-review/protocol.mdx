...
---
<Video uid="f9be0812-8ada-4290-b4ec-323769ba2eaa" src="https://www.youtube.com/embed/6bJ-Gs6WSm0" render-type="iframe" width="560" height="315" controls="true" allow-full-screen="true" />
...
In a [Dual Review](/systematic-review/dual-review/how-it-works), the reviewer chooses the exclusion reason. When they exclude a paper, they pick the one criterion that best explains it, and that criterion is what the review reports.
...
### Editing criteria in a Dual Review

In a dual review the screening decisions were made by people, against the criteria as they stood at the time. When you save a change to the criteria of a stage that is underway, Paperguide asks how to treat those decisions:
...
- **Apply changes and reset only affected decisions.** Only the decisions the change actually touches are cleared. Adding a criterion resets Include and Maybe decisions, since they never checked the new rule. Deleting or editing a criterion resets the decisions that depended on it.

Reset papers return to both reviewers' queues. Anything that followed from a reset decision, a conflict resolution, later-stage work on that paper, or a generated report, is cleared with it. [How Dual Review works](/systematic-review/dual-review/how-it-works#editing-the-protocol-during-screening) has the full table.
