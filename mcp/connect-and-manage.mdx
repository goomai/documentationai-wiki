...
<Callout kind="info" collapsed="false">
  ...
  - You can check usage at Settings → Usage, under Connected Apps (MCP).
...
You can see and manage every AI assistant connected to your account at Settings → Profile → Connected Apps.
